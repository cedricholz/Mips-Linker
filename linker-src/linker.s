...
write_machine_code_next_inst:
	...
	move $a0, $v1					##Set args and stuff
	addiu $a1, $0 16				##set base to 16
	jal parse_int
	addu $a0, $v0, $0				##Store instruction to a0 for next part	
	move $s6, $a0
